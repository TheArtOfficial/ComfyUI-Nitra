...
const PROFILE_KEY = 'nitra_user_profile';
const USER_ID_KEY = 'nitra_user_id';
const USER_EMAIL_KEY = 'nitra_user_email';
...
export function decodeTokenExpiry(token) {
    ...
    try {
        ...
        console.warn('Nitra: Unable to decode token expiry', error);
    }
    return null;
}
...
export function persistUserProfile(user, tokens = {}) {
    ...
    try {
        ...
        console.warn('Nitra: Failed to persist user profile', error);
    }
...
export function loadStoredUserProfile() {
    try {
        ...
        console.warn('Nitra: Failed to load stored user profile', error);
...
export function clearStoredUserProfile() {
    try {
        ...
        console.warn('Nitra: Failed to clear stored user profile', error);
    }
