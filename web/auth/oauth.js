...
function encodeStatePayload(payload) {
    try {
        ...
        console.warn('Nitra: Failed to encode auth state payload', error);
...
function decodeStatePayload(stateParam) {
    ...
    try {
        ...
        console.warn('Nitra: Failed to decode auth state payload', error);
        return null;
    }
}
...
function redirectToOriginalOrigin(statePayload, urlParams) {
    ...
    try {
        ...
        console.warn('Nitra: Failed to redirect to original auth origin', error);
        return false;
    }
}
